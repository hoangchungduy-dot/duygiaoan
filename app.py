...
<div class="main-header">
    ...
    <p>Tác giả: hoàng Thị Duy - Trường  Tiểu học Bản Vĩnh thành - ĐT: 0839132530</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Hoàng Thị Duy - Trường  Tiểu học vinh thành - ĐT: 097 1986 343</div>", unsafe_allow_html=True)
